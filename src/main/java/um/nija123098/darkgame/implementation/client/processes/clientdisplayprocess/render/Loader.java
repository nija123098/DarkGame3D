...
import um.nija123098.darkgame.implementation.client.processes.clientdisplayprocess.textures.TextureData;
...
public class Loader {
    ...
    public int loadTexture(String fileName){
        ...
        try {
            texture = TextureLoader.getTexture("PNG", new FileInputStream(Resource.getPath(Resource.ResourceType.TEXTURE, fileName)));
    ...
    private TextureData decodeTextureFile(String fileName) {
        ...
        try {
            FileInputStream in = new FileInputStream(Resource.getPath(Resource.ResourceType.TEXTURE, fileName));
