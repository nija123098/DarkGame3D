...
public class Terrain {
    ...
    private String hightMapFileName;
    private float[][] heights;
    public Terrain(float x, float z, Loader loader, TerrainTexturePack texturePack, String hightMapFileName) {
        this.texturePack = texturePack;
        this.x = x;
        this.z = z;
        this.hightMapFileName = hightMapFileName;
        this.model = this.generateTerrain(loader, this.hightMapFileName);
    }/*
